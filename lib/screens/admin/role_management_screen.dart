              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    _buildRoleInfo('Shopper', 'Can mark shopping items as purchased/unavailable (all adults by default)'),
                  ],
                ),
              ),
            ),
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                _buildRoleChip('Shopper', member.isShopper(), (value) {
                  _toggleRole(member, 'shopper', value);
                }, false, _currentUser?.isAdmin() ?? false),
              ],
            ),
          ],
