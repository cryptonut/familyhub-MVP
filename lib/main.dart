    ...
    if (kIsWeb) {
      ...
      try {
        ...
        try {
          ...
          // NOTE: This is called in BOTH Flutter (here) and Android MainActivity for redundancy
          // The MainActivity code may run before Firebase is fully initialized, so we also do it here
          try {
            ...
            Logger.warning('MainActivity will also attempt to disable app verification', tag: 'main');
          }
        } catch (e, st) {
